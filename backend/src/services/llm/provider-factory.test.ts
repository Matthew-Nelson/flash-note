...
import { createLLMProvider, getConfiguredProvider } from './provider-factory.js';
...
describe('LLM Provider Factory', () => {
  describe('createLLMProvider', () => {
    describe('Gemini provider', () => {
      ...
      it('should throw error when geminiApiKey is missing', () => {
        expect(() =>
  ...
  describe('getConfiguredProvider', () => {
    ...
    it('should work with all provider-specific config options', () => {
      const geminiProvider = getConfiguredProvider({
        ...
        geminiModel: 'gemini-2.5-flash',
        claudeApiKey: 'claude-key', // Should be ignored
        claudeModel: 'claude-model', // Should be ignored
      });
      ...
      const claudeProvider = getConfiguredProvider({
        provider: 'claude',
        geminiApiKey: 'gemini-key', // Should be ignored
        geminiModel: 'gemini-model', // Should be ignored

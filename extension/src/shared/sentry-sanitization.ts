 ...
 *
 * NOTE: This mirrors the backend sanitization logic in backend/src/utils/sentry-sanitization.ts.
 * If you update patterns here, update the backend version too.
 */

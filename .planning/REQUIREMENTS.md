...
- [ ] **UIPOL-03**: Remaining spinner loading states replaced with content-shaped skeletons
- [ ] **UIPOL-04**: All pages render without horizontal scroll at 375px viewport
- [ ] **UIPOL-05**: Generated notes have a print stylesheet
